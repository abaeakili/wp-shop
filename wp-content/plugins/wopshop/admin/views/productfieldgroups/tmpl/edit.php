...
<form method="POST" action="admin.php?page=options&tab=productfieldgroups&task=save" enctype="multipart/form-data">
    <div class="wrap">
    ...
    <div clas="submit">
        <p class="submit">
            ...
            <a class="button" href="admin.php?page=options&tab=productfieldgroups"><?php echo _WOP_SHOP_BACK; ?></a>
        </p>
    </div>
