...
<fieldset class="adminform">
    <legend><?php echo _WOP_SHOP_STORE_INFO ?></legend>
    ...
    <tr>
     <td class="key">
       <?php echo _WOP_SHOP_STORE_ADRESS;?>
     </td>
     <td>
    ...
    <tr>
     <td class="key">
       <?php echo _WOP_SHOP_STORE_STATE;?>
     </td>
     <td>
    ...
    <tr>
     <td class="key">
       <?php echo _WOP_SHOP_STORE_COUNTRY;?>
     </td>
     <td>
...
<fieldset class="adminform">
    <legend><?php echo _WOP_SHOP_CONTACT_INFO ?></legend>
    <table class="admintable table-striped" width="100%" >
    <tr>
     <td  class="key">
       <?php echo _WOP_SHOP_CONTACT_FIRSTNAME;?>
     </td>
     <td>
    ...
    <tr>
     <td  class="key">
       <?php echo _WOP_SHOP_CONTACT_LASTNAME;?>
     </td>
     <td>
    ...
    <tr>
     <td  class="key">
       <?php echo _WOP_SHOP_CONTACT_MIDDLENAME;?>
     </td>
     <td>
    ...
    <tr>
     <td  class="key">
       <?php echo _WOP_SHOP_CONTACT_PHONE;?>
     </td>
     <td>
    ...
    <tr>
     <td  class="key">
       <?php echo _WOP_SHOP_CONTACT_FAX;?>
     </td>
     <td>
...
<fieldset class="adminform">
    <legend><?php echo _WOP_SHOP_PDF_CONFIG ?></legend>
    <table class="admintable table-striped" width="100%" >
    <tr>
    <td  class="key">
       <?php echo _WOP_SHOP_PDF_HEADER?>
    </td>
    <td>
    ...
    <td>
        <input size="55" type="text" class="inputbox" name="pdf_parameters[pdf_header_width]" value="<?php echo $config->pdf_header_width?>" />
    </td>
    </tr>
    <tr>
    <td  class="key">
    ...
    <td>
        <input size="55" type="text" class="inputbox" name="pdf_parameters[pdf_header_height]" value="<?php echo $config->pdf_header_height?>" />
    </td>
    </tr>
    <tr>
    <td> </td>
    ...
    <td>
        <input size="55" type="text" class="inputbox" name="pdf_parameters[pdf_footer_width]" value="<?php echo $config->pdf_footer_width?>" />
    </td>
    </tr>
    <tr>
    <td  class="key">
    ...
    <td>
        <input size="55" type="text" class="inputbox" name="pdf_parameters[pdf_footer_height]" value="<?php echo $config->pdf_footer_height?>" />
    </td>
    </tr>
    <tr>
    <td></td>
    <td >
        <?php print _WOP_SHOP_PDF_PREVIEW_INFO1;?>
        <a target="_blank" href="admin.php?page=configuration&task=preview_pdf&config_id=<?php echo $config->id?>"><?php echo _WOP_SHOP_PDF_PREVIEW?></a>
    </td>
    </tr>
    </table>
...
<fieldset class="adminform">
    ...
    <tr>
     ...
     <td>
       <input size="55" type="text" class="inputbox" name="store_date_format" value="<?php echo $config->store_date_format?>" />
     </td>
    </tr>
    </table>
</fieldset>
...
<fieldset class="adminform">
    ...
    <td >
        <?php print _WOP_SHOP_PDF_PREVIEW_INFO1;?>
        <a target="_blank" href="admin.php?page=configuration&task=preview_pdf"><?php echo _WOP_SHOP_PDF_PREVIEW?></a>
    </td>
    </tr>
    </table>
