...
$start=intval(Request::getInt("start")/$this->limit)+1;
...
<div class="block_related" id="serched_product_<?php print $row->product_id;?>">
    <div class="block_related_inner">
        ...
        <div class="image">
            <a href="admin.php?page=products&task=edit&product_id=<?php print $row->product_id?>">
        ...
        <div style="padding-top:5px;"><input type="button" value="<?php print _WOP_SHOP_ADD;?>" onclick="add_to_list_relatad(<?php print $row->product_id;?>)"></div>
    </div>
</div>
<?php
}
...
<table align="center">
<tr>
    <td><?php print _WOP_SHOP_PAGE?>: </td>
    <td>
