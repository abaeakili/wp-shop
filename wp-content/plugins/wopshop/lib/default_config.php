...
$config->sorting_products_name_select = array(
    1 => _WOP_SHOP_SORT_ALPH,  
    2 => _WOP_SHOP_SORT_PRICE,           
    3 => _WOP_SHOP_SORT_DATE,          
    5 => _WOP_SHOP_SORT_RATING,    
    6 => _WOP_SHOP_SORT_POPULAR, 
    4 => _WOP_SHOP_SORT_MANUAL
);

$config->user_field_title = array(
    0 => _WOP_SHOP_REG_SELECT,
    1 => _WOP_SHOP_MR,
    2 => _WOP_SHOP_MS
);
...
$config->user_field_client_type = array(
    0 => _WOP_SHOP_REG_SELECT, 
    1 => _WOP_SHOP_PRIVAT_CLIENT, 
    2 => _WOP_SHOP_FIRMA_CLIENT
);
