...
<table class = "wshop cart cartwishlist" id="wshop_plugin">
    <tr>
        ...
        <th class="remove_to_cart" width = "10%">
            <?php print _WOP_SHOP_REMOVE_TO_CART ?>
        </th>
            ...
            <div class="data">
                ...
                <?php if ($this->config->cart_basic_price_show && $prod['basicprice']>0){?>
                    <div class="basic_price">
                        <?php print _WOP_SHOP_BASIC_PRICE?>: <span><?php print sprintBasicPrice($prod);?></span>
                    </div>
                <?php }?>
            </div>
        </td>
        ...
        <td class="remove_to_cart">
            ...
            <div class="data">
                <a class="button-img" href = "<?php print $prod['remove_to_cart'] ?>" >
                    <img src = "<?php print $this->image_path ?>/assets/images/reload.png" alt = "<?php print _WOP_SHOP_REMOVE_TO_CART?>" title = "<?php print _WOP_SHOP_REMOVE_TO_CART?>" />
                </a>
    ...
    <div id = "checkout">
        ...
        <div class = "pull-right td_2">
            <a href = "<?php print $this->href_checkout ?>" class = "btn">
                <?php print _WOP_SHOP_GO_TO_CART ?>
            </a>
        </div>
