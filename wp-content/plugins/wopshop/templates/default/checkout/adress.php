    ...
    <div class="wshop address_block">
        ...
        <form action = "<?php print $this->action ?>" method = "post" name = "loginForm" onsubmit = "return validateCheckoutAdressForm('<?php print $this->live_path ?>', this.name)" class = "form-horizontal" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class = "wshop_register">
                ...
                <div class = "control-group">
                  <div class = "control-label name">
                    <?php print _WOP_SHOP_EMAIL2 ?> <?php if ($config_fields['email2']['require']){?><span>*</span><?php } ?>
                  </div>
                  <div class = "controls">
            ...
            <div class="wshop_register wshop_block_privacy_statement">
                <div class = "control-group">
                    <div class = "control-label name">
            ...
            <div class = "control-group box_button">
                <div class = "controls">
                    ...
                    <input type = "submit" name = "next" value = "<?php print _WOP_SHOP_NEXT ?>" class = "btn btn-primary button" />
                </div>
            </div>
        </form>
    </div>
