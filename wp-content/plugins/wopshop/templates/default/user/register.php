...
<div class="wshop" id="wshop_register">
    ...
    <h1><?php print _WOP_SHOP_REGISTRATION;?></h1>
    <?php endif; ?>
    
    <form action = "<?php print SEFLink('controller=user&task=registersave',1,0, $this->config->use_ssl)?>" class = "form-validate form-horizontal" method = "post" name = "loginForm" onsubmit = "return validateRegistrationForm('<?php print $this->urlcheckdata?>', this.name)" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class = "wshop_register">
        ...
        <div class = "control-group">
            <div class = "control-label name">
                <?php print _WOP_SHOP_REG_TITLE?> <?php if ($config_fields['title']['require']) : ?><span>*</span><?php endif; ?>
            </div>
            <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_F_NAME ?> <?php if ($config_fields['f_name']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_L_NAME ?> <?php if ($config_fields['l_name']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_M_NAME ?> <?php if ($config_fields['m_name']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_FIRMA_NAME ?> <?php if ($config_fields['firma_name']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_CLIENT_TYPE ?> <?php if ($config_fields['client_type']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group" id = 'tr_field_firma_code' <?php if ($config_fields['client_type']['display']) : ?>style="display:none;"<?php endif; ?>>
          <div class = "control-label name">
            <?php print _WOP_SHOP_FIRMA_CODE ?> <?php if ($config_fields['firma_code']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group" id = 'tr_field_tax_number' <?php if ($config_fields['client_type']['display']) : ?>style="display:none;"<?php endif; ?>>
          <div class = "control-label name">
            <?php print _WOP_SHOP_VAT_NUMBER ?> <?php if ($config_fields['tax_number']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_EMAIL ?> <?php if ($config_fields['email']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_EMAIL2 ?> <?php if ($config_fields['email2']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_BIRTHDAY?> <?php if ($config_fields['birthday']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">  
    ...
    <div class = "wshop_register">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_HOME ?> <?php if ($config_fields['home']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_APARTMENT ?> <?php if ($config_fields['apartment']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_STREET_NR ?> <?php if ($config_fields['street']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_ZIP ?> <?php if ($config_fields['zip']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_CITY ?> <?php if ($config_fields['city']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_STATE ?> <?php if ($config_fields['state']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_COUNTRY ?> <?php if ($config_fields['country']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
    ...
    <div class = "wshop_register">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_TELEFON ?> <?php if ($config_fields['phone']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_MOBIL_PHONE ?> <?php if ($config_fields['mobil_phone']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_FAX ?> <?php if ($config_fields['fax']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_EXT_FIELD_1 ?> <?php if ($config_fields['ext_field_1']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_EXT_FIELD_2 ?> <?php if ($config_fields['ext_field_2']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_EXT_FIELD_3 ?> <?php if ($config_fields['ext_field_3']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
    ...
    <div class = "wshop_register last_register_block">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_USERNAME ?> <?php if ($config_fields['u_name']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_PASSWORD ?> <?php if ($config_fields['password']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            <?php print _WOP_SHOP_PASSWORD_2 ?> <?php if ($config_fields['password_2']['require']) : ?><span>*</span><?php endif; ?>
          </div>
          <div class = "controls">
        ...
        <div class = "control-group">
          <div class = "control-label name">
            ...
            <?php print _WOP_SHOP_PRIVACY_STATEMENT?> <?php if ($config_fields['privacy_statement']['require']) : ?><span>*</span><?php endif; ?>
            </a>            
          </div>
          <div class = "controls">
    ...
    <div class = "control-group box_button">
        <div class = "controls">
            ...
            <input type="submit" value = "<?php print _WOP_SHOP_SEND_REGISTRATION ?>" class = "btn btn-primary button" />
        </div>
    </div>
    <?php //echo JHtml::_('form.token');?>
    </form>
</div>
<?php wp_add_inline_script('jquery-ui-datepicker', "jQuery('#birthday').datepicker({dateFormat: '".$this->format."'});"); ?>