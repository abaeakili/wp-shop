...
<div class="product productitem_<?php print $product->product_id?>">
    ...
    <div class="name">
        ...
        <?php if ($this->config->product_list_show_product_code){?>
            <span class="wshop_code_prod">(<?php print _WOP_SHOP_EAN?>: <span><?php print $product->product_ean;?></span>)</span>
        <?php }?>
    </div>
    ...
    <div class = "image">
        <?php if ($product->image){?>
            <div class="image_block">
                ...
                <?php }?>
                <a href="<?php print $product->product_link?>">
                    <img class="wshop_img" src="<?php print $product->image?>" alt="<?php print htmlspecialchars($product->name);?>" title="<?php print htmlspecialchars($product->name);?>"  />
                </a>
            </div>
        <?php }?>
    ...
    <div class = "oiproduct">
        ...
        <?php if ($product->product_old_price > 0){?>
            <div class="old_price">
                <?php if ($this->config->product_list_show_price_description) print _WOP_SHOP_OLD_PRICE.": ";?>
        ...
        <?php if ($product->product_price_default > 0 && $this->config->product_list_show_price_default){?>
            <div class="default_price">
                <?php print _WOP_SHOP_DEFAULT_PRICE.": ";?>
        ...
        <?php if ($product->_display_price){?>
            <div class = "wshop_price">
                <?php if ($this->config->product_list_show_price_description) print _WOP_SHOP_PRICE.": ";?>
        ...
        <?php if ($product->basic_price_info['price_show']){?>
            <div class="base_price">
                ...
                <?php if ($product->show_price_from && !$this->config->hide_from_basic_price) print _WOP_SHOP_FROM;?> 
